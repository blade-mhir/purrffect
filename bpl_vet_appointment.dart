...
class BPLVetAppointment extends StatefulWidget {
  const BPLVetAppointment({Key? key}) : super(key: key);

  @override
  State<BPLVetAppointment> createState() => _BPLVetAppointmentState();

}

// Define the state class for Vet Appointment widget
class _BPLVetAppointmentState extends State<BPLVetAppointment> {
  ...
  void initState() {
    super.initState();
    _vetNameController.text = 'Bicol Pet Lovers Veterinary Clinic';
    _vetNumController.text = '0917 885 7740';
