...
class FPGSGroomerAppointment extends StatefulWidget {
  const FPGSGroomerAppointment({Key? key}) : super(key: key);

  @override
  State<FPGSGroomerAppointment> createState() => _FPGSGroomerAppointmentState();
}

// Define the state class for Groomer Appointment Widget
class _FPGSGroomerAppointmentState extends State<FPGSGroomerAppointment> {
  ...
  void initState() {
    super.initState();
    _groomerNameController.text = 'Furfect Pet Grooming Services';
  ...
  void navigateToFPGSGroomerAppointments(String selectedDate, String selectedTimeSlot, String selectedServiceOption,String groomerReason, String chosenPet, String groomerName, String groomerNum, String groomerAdd) {
    Navigator.push(
      context,
      MaterialPageRoute(
                                        ...
                                        showDialog(
                                          ...
                                          builder: (BuildContext context) {
                                            return ChoosePetDialog(
                                              ...
                                              onNavigateToAppointments: navigateToFPGSGroomerAppointments,
                                              selectedDate: selectedDate,
