...
class PPGroomerAppointment extends StatefulWidget {
  const PPGroomerAppointment({Key? key}) : super(key: key);

  @override
  State<PPGroomerAppointment> createState() => _PPGroomerAppointmentState();
}

// Define the state class for Groomer Appointment Widget
class _PPGroomerAppointmentState extends State<PPGroomerAppointment> {
  ...
  void initState() {
    super.initState();
    _groomerNameController.text = 'Poochie Parlor';
    _groomerNumController.text = '0921 846 7221';
    _groomerAddController.text = 'Crescini Bldg., Triangulo Central Business District, Naga City';
  }

  void navigateToPPGroomerAppointments(String selectedDate, String selectedTimeSlot, String selectedServiceOption,String groomerReason, String chosenPet, String groomerName, String groomerNum, String groomerAdd) {
    Navigator.push(
      context,
      MaterialPageRoute(
                                        ...
                                        showDialog(
                                          ...
                                          builder: (BuildContext context) {
                                            return ChoosePetDialog(
                                              ...
                                              onNavigateToAppointments: navigateToPPGroomerAppointments,
                                              selectedDate: selectedDate,
