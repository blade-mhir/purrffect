...
class KHOVetAppointment extends StatefulWidget {
  const KHOVetAppointment({Key? key}) : super(key: key);

  @override
  State<KHOVetAppointment> createState() => _KHOVetAppointmentState();

}

// Define the state class for Vet Appointment widget
class _KHOVetAppointmentState extends State<KHOVetAppointment> {
  ...
  void initState() {
    super.initState();
    _vetNameController.text = 'KHO Veterinary Clinic';
    _vetNumController.text = '0929 694 4414';
    _vetAddController.text = 'TCDC Compound Zone 5 Concepcion Grande, Naga City';
  }
